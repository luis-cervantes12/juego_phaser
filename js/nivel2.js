export class nivel2 extends Phaser.Scene{
    ...
    create ()
    {
        ...
        this.platforms.create(0, 500, 'ground2'); 
        this.platforms.create(300, 400, 'ground2');
        this.platforms.create(450, 250, 'ground2');
        this.platforms.create(600, 400, 'ground2');
        this.platforms.create(1200, 450, 'ground2');
        this.platforms.create(1500, 300, 'ground2');
        this.platforms.create(1600, 600, 'ground2');
        this.platforms.create(2000, 550, 'ground2');
        this.platforms.create(2200, 400, 'ground2');
        this.platforms.create(2400, 550, 'ground2');
        this.platforms.create(2800, 500, 'ground2');
        this.platforms.create(3000, 350, 'ground2');
        this.platforms.create(3300, 150, 'ground2');
        
        this.finale = this.physics.add.image(3300,150,'final');
        this.finale.setCollideWorldBounds(true)

export class Nivel1 extends Phaser.Scene{
    ...
    {   
        ...
        this.load.audio('musica1', 'assets/musica.mp3');
    }
    ...
    create ()
    {
        ...
        this.musicaFondo = this.sound.add('musica1');
        ...
        this.finale = this.physics.add.image(3000,200,'final');
        this.finale.setCollideWorldBounds(true)
        //musica para salto
        this.audio = this.sound.add('salto', {loop: false});
